...
See [current status](status-2026-09-21.md) before using the historical notes below.

## First read

1. [Execution status](status-2026-09-21.md), [product contract](../product.md), [architecture](../architecture.md), [agent contract](../agent-contract.md).
...
4. [Accepted cover-index contract](../handoff/cover-index-task.md), [cover source inventory](../handoff/cover-source-inventory.md), and [preparation notes](../handoff/cover-preparation.md). Preparation includes historical estimates; 93.06 MiB covers stock only, while the later 127.54 MiB CPU profile includes stock and cover.
...
Historical judgment estimate was roughly 50% of runtime recovery and 20–25% of the full faithful-London goal; these are not measured delivery percentages. [Execution ledger](../handoff/execution-ledger.md) preserves prior acceptance decisions and rulings for recovery, including interrupted attempts.
