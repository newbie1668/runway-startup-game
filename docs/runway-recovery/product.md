...
| P7  | **Superseded 24 Sep 2026: desktop browser only** ([decision 4](definition-of-done.md)). Was: responsive mobile layout and usable controls; weak devices retain playable 2D.                                                                                                 | Named reference devices, touch checks and performance record.                                        |
