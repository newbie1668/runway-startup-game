...
Updated: 6 September 2026. Execution wave 2 (R2) is recorded on `build/runway-recovery` in an isolated worktree.
...
- Current frontier: **F1a integrated; R0 baseline captured; R2 accepted; R1 next**. [R1 preparation](evidence/R1/preparation.md) records the renderer seams and contract decisions to resolve before dispatch. F1 source/photo/metric coverage and F1 GO remain pending. The R2 browser deliberately exercises automatic/explicit 2D; it does not certify 3D readiness or performance.
