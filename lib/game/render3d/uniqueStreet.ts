 ...
 *
 * No. 1 Poultry is a noticed-tray GLB (`pnpm bake:poultry`), not a hull here.
 * Other pins (The Ned, St Stephen Walbrook, Magistrates' Court, 1 Old Jewry,
 * Mansion House, 33 Gresham Street, Bloomberg London, Bank of England)
 * stay uniqueStreet. No live fetch in the client.
 */
...
/** Hull-absence tests still match these leftover course / clock paints. */
